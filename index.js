...
async function run() {
  try {
    ...
    // global variables for every call
    const coffeeCollection = client.db("coffeeDB").collection("coffee")
    // to read the data that i posted
    ...
    // get the specific data and delete
    app.delete('/coffee/:id', async(req, res) =>{
      ...
      // post section i meant create data from client
